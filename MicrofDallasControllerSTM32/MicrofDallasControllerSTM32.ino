...
void setup(void)
{
  ...
  sensors.begin();
  //sensors.setResolution(insideThermometer, DefaultResolution);RIGHT
  printInformation();   
}
...
void printInformation(){
  ...
  Serial.println(";");
  Serial1.println("Information sending");
}
...
void printTemperature(DeviceAddress deviceAddress, int i)
{
  ...
  Serial1.println("Device "+(String)i+" Temp C: " + tempC);
...
{ 
  ...
  {
    //Serial1.println("Hello world! This is the debug channel.");
